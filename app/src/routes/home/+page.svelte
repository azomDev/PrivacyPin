...
<div class="inner-card" style="line-height: 0; height: 20px;">
	<div class="split-lr" style="margin-bottom: 0; height: 20px;">
		<div style="display: flex">
			...
			>
				<MapPin color="#a538d1" size={25} style="margin-top: 12.5; margin-bottom: 12.5;" />
			</a>
			<!-- Pin Icon -->
...
<div class="split-lr" style="width: 100%">
	<p style="float: left; padding-top: 5px; padding-left: 0; padding-bottom: 5px;">Last ping sent:</p>
	<p style="font-style: bold; float: right; padding-top: 5px; padding-right: 0; padding-bottom: 5px;">
